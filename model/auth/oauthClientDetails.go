...
type OAuthClientDetails struct {
	...
	Scope                string `gorm:"type:varchar(255)" db:"scope"`                   // Nullable
	AuthorizedGrantTypes string `gorm:"type:varchar(255)" db:"authorized_grant_types"`  // Nullable
	WebServerRedirectURI string `gorm:"type:varchar(255)" db:"web_server_redirect_uri"` // Nullable
