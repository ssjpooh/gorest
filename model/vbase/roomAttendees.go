...
func (RoomAttendees) TableName() string {
	return "room_attendees"
}

var RoomAttendeesColumns = fmt.Sprintf(" %s ", strings.Join(db.ColumnsForStruct(RoomAttendees{}), ", "))
